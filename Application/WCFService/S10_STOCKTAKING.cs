...
namespace KyoeiSystem.Application.WCFService
{
    ...
    public partial class S10_STOCKTAKING: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public System.DateTime 棚卸日
        {
            ...
            set
            {
                if (_棚卸日 != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property '棚卸日' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _棚卸日 = value;
                    OnPropertyChanged("棚卸日");
                }
            }
        }
        private System.DateTime _棚卸日;
        ...
        public int 品番追加FLG
        {
            ...
            set
            {
                ...
                {
                    _品番追加FLG = value;
                    OnPropertyChanged("品番追加FLG");
                }
            }
        }
        private int _品番追加FLG;
        ...
        public int 更新済みFLG
        {
            ...
            set
            {
                ...
                {
                    _更新済みFLG = value;
                    OnPropertyChanged("更新済みFLG");
                }
            }
        }
        private int _更新済みFLG;
