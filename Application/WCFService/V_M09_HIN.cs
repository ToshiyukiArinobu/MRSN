...
namespace KyoeiSystem.Application.WCFService
{
    ...
    public partial class V_M09_HIN: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public string 自社色名
        {
            ...
            set
            {
                ...
                {
                    _自社色名 = value;
                    OnPropertyChanged("自社色名");
                }
            }
        }
        private string _自社色名;
        ...
        public string 商品形態分類名
        {
            ...
            set
            {
                ...
                {
                    _商品形態分類名 = value;
                    OnPropertyChanged("商品形態分類名");
                }
            }
        }
        private string _商品形態分類名;
        ...
        public string 商品分類名
        {
            ...
            set
            {
                ...
                {
                    _商品分類名 = value;
                    OnPropertyChanged("商品分類名");
                }
            }
        }
        private string _商品分類名;
        ...
        public string ブランド名
        {
            ...
            set
            {
                ...
                {
                    _ブランド名 = value;
                    OnPropertyChanged("ブランド名");
                }
            }
        }
        private string _ブランド名;
        ...
        public string 消費税区分名
        {
            ...
            set
            {
                ...
                {
                    _消費税区分名 = value;
                    OnPropertyChanged("消費税区分名");
                }
            }
        }
        private string _消費税区分名;
