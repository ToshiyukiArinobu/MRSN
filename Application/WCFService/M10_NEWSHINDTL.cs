...
namespace KyoeiSystem.Application.WCFService
{
    ...
    public partial class M10_NEWSHINDTL: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int 構成行
        {
            ...
            set
            {
                if (_構成行 != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property '構成行' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _構成行 = value;
                    OnPropertyChanged("構成行");
                }
            }
        }
        private int _構成行;
        ...
        public decimal 必要数量
        {
            ...
            set
            {
                ...
                {
                    _必要数量 = value;
                    OnPropertyChanged("必要数量");
                }
            }
        }
        private decimal _必要数量;
