...
namespace KyoeiSystem.Application.WCFService
{
    ...
    public partial class M16_HINGUN: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public string 品群コード
        {
            ...
            set
            {
                if (_品群コード != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property '品群コード' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _品群コード = value;
                    OnPropertyChanged("品群コード");
                }
            }
        }
        private string _品群コード;
