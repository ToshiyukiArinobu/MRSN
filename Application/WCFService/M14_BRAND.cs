...
namespace KyoeiSystem.Application.WCFService
{
    ...
    public partial class M14_BRAND: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public string ブランドコード
        {
            ...
            set
            {
                if (_ブランドコード != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'ブランドコード' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _ブランドコード = value;
                    OnPropertyChanged("ブランドコード");
                }
            }
        }
        private string _ブランドコード;
