...
namespace KyoeiSystem.Application.WCFService
{
    ...
    public partial class M11_TEK: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int 摘要ID
        {
            ...
            set
            {
                if (_摘要ID != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property '摘要ID' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _摘要ID = value;
                    OnPropertyChanged("摘要ID");
                }
            }
        }
        private int _摘要ID;
