...
namespace KyoeiSystem.Application.WCFService
{
    ...
    public class SRY08010_KEI_Member
    {
        [DataMember]
	...
	public class SRY08010_PRELIST_Member
	{
		[DataMember]
		public int 印刷グループID { get; set; }
		[DataMember]
	...
	public class SRY08010_PRELIST_Member_CSV
	{
		public int 車輌ID { get; set; }
		public string 車輌番号 { get; set; }
    ...
    #region SRY08010_Member

    public class SRY08010_Member
    {
        [DataMember]
        public int? 車輌ID { get; set; }
        [DataMember]
    ...
    public class SRY08010
    {
        #region SRY08010 印刷
        public List<SRY08010_Member> SRY08010_GetDataList(string s車輌From , string s車輌To , int?[] i車輌List, string s車輌List, int 年, int 月)
        {
            using (TRAC3Entities context = new TRAC3Entities(CommonData.TRAC3_GetConnectionString()))
            {
                ...
                List<SRY08010_Member> retList = new List<SRY08010_Member>();
                ...
                try
                {
                    ...
                    var carlistz = (from m05 in context.M05_CAR.Where(c => c.削除日付 == null)
                                   join s14z in context.S14_CAR.Where(c => c.集計年月 >= i開始年月 && c.集計年月 <= i終了年月) on m05.車輌KEY equals s14z.車輌KEY into s14zGroup
                                   //join s14 in context.S14_CAR.Where(c => c.集計年月 >= i開始年月 && c.集計年月 <= i終了年月) on m05.車輌KEY equals s14.車輌KEY
                                   ...
                                   select new SRY08010g_Member 
                                   {
                                       ...
                                       運送収入1 = s14zGroup.Where(c => c.集計年月 == i年月1).Select(c => c.運送収入).Sum(),
                                       運送収入2 = s14zGroup.Where(c => c.集計年月 == i年月2).Select(c => c.運送収入).Sum(),
                                       運送収入3 = s14zGroup.Where(c => c.集計年月 == i年月3).Select(c => c.運送収入).Sum(),
                                       運送収入4 = s14zGroup.Where(c => c.集計年月 == i年月4).Select(c => c.運送収入).Sum(),
                                       運送収入5 = s14zGroup.Where(c => c.集計年月 == i年月5).Select(c => c.運送収入).Sum(),
                                       運送収入6 = s14zGroup.Where(c => c.集計年月 == i年月6).Select(c => c.運送収入).Sum(),
                                       運送収入7 = s14zGroup.Where(c => c.集計年月 == i年月7).Select(c => c.運送収入).Sum(),
                                       運送収入8 = s14zGroup.Where(c => c.集計年月 == i年月8).Select(c => c.運送収入).Sum(),
                                       運送収入9 = s14zGroup.Where(c => c.集計年月 == i年月9).Select(c => c.運送収入).Sum(),
                                       運送収入10 = s14zGroup.Where(c => c.集計年月 == i年月10).Select(c => c.運送収入).Sum(),
                                       運送収入11 = s14zGroup.Where(c => c.集計年月 == i年月11).Select(c => c.運送収入).Sum(),
                                       運送収入12 = s14zGroup.Where(c => c.集計年月 == i年月12).Select(c => c.運送収入).Sum(),
                                       運送収入13 = s14zGroup.Where(c => c.集計年月 >= i年月1 && c.集計年月 <= i年月12).Select(c => c.運送収入).Sum(),
                                       運送収入14 = s14zGroup.Where(c => c.集計年月 >= i年月1 && c.集計年月 <= i年月12).Select(c => c.運送収入).Sum() / 12,
                                       運送収入15 = 0,

                                       一般管理費1 = s14zGroup.Where(c => c.集計年月 == i年月1).Select(c => c.一般管理費).Sum(),
                                       一般管理費2 = s14zGroup.Where(c => c.集計年月 == i年月2).Select(c => c.一般管理費).Sum(),
                                       一般管理費3 = s14zGroup.Where(c => c.集計年月 == i年月3).Select(c => c.一般管理費).Sum(),
                                       一般管理費4 = s14zGroup.Where(c => c.集計年月 == i年月4).Select(c => c.一般管理費).Sum(),
                                       一般管理費5 = s14zGroup.Where(c => c.集計年月 == i年月5).Select(c => c.一般管理費).Sum(),
                                       一般管理費6 = s14zGroup.Where(c => c.集計年月 == i年月6).Select(c => c.一般管理費).Sum(),
                                       一般管理費7 = s14zGroup.Where(c => c.集計年月 == i年月7).Select(c => c.一般管理費).Sum(),
                                       一般管理費8 = s14zGroup.Where(c => c.集計年月 == i年月8).Select(c => c.一般管理費).Sum(),
                                       一般管理費9 = s14zGroup.Where(c => c.集計年月 == i年月9).Select(c => c.一般管理費).Sum(),
                                       一般管理費10 = s14zGroup.Where(c => c.集計年月 == i年月10).Select(c => c.一般管理費).Sum(),
                                       一般管理費11 = s14zGroup.Where(c => c.集計年月 == i年月11).Select(c => c.一般管理費).Sum(),
                                       一般管理費12 = s14zGroup.Where(c => c.集計年月 == i年月12).Select(c => c.一般管理費).Sum(),
                                       一般管理費13 = s14zGroup.Where(c => c.集計年月 >= i年月1 && c.集計年月 <= i年月12).Select(c => c.一般管理費).Sum(),
                                       一般管理費14 = s14zGroup.Where(c => c.集計年月 >= i年月1 && c.集計年月 <= i年月12).Select(c => c.一般管理費).Sum() / 12,
                                       一般管理費15 = 0,
                                   }).AsQueryable();

					var carlistz_1 = carlistz;
					if (i車輌List.Length > 0)
					{
						carlistz_1 = carlistz.Where(c => i車輌List.Contains(c.車輌ID));
						if (string.IsNullOrEmpty(s車輌From + s車輌To))
						{
							carlistz = carlistz.Where(q => q.車輌ID > int.MaxValue);
						}
					}
					...
					carlistz = carlistz.Union(carlistz_1);
					...
					//								運送収入1 = s14zGroup.Where(c => c.集計年月 == i年月1).Select(c => c.運送収入).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月1).Select(c => c.運送収入).Sum(),
					//								運送収入2 = s14zGroup.Where(c => c.集計年月 == i年月2).Select(c => c.運送収入).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月2).Select(c => c.運送収入).Sum(),
					//								運送収入3 = s14zGroup.Where(c => c.集計年月 == i年月3).Select(c => c.運送収入).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月3).Select(c => c.運送収入).Sum(),
					//								運送収入4 = s14zGroup.Where(c => c.集計年月 == i年月4).Select(c => c.運送収入).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月4).Select(c => c.運送収入).Sum(),
					//								運送収入5 = s14zGroup.Where(c => c.集計年月 == i年月5).Select(c => c.運送収入).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月5).Select(c => c.運送収入).Sum(),
					//								運送収入6 = s14zGroup.Where(c => c.集計年月 == i年月6).Select(c => c.運送収入).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月6).Select(c => c.運送収入).Sum(),
					//								運送収入7 = s14zGroup.Where(c => c.集計年月 == i年月7).Select(c => c.運送収入).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月7).Select(c => c.運送収入).Sum(),
					//								運送収入8 = s14zGroup.Where(c => c.集計年月 == i年月8).Select(c => c.運送収入).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月8).Select(c => c.運送収入).Sum(),
					//								運送収入9 = s14zGroup.Where(c => c.集計年月 == i年月9).Select(c => c.運送収入).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月9).Select(c => c.運送収入).Sum(),
					//								運送収入10 = s14zGroup.Where(c => c.集計年月 == i年月10).Select(c => c.運送収入).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月3).Select(c => c.運送収入).Sum(),
					//								運送収入11 = s14zGroup.Where(c => c.集計年月 == i年月11).Select(c => c.運送収入).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月3).Select(c => c.運送収入).Sum(),
					//								運送収入12 = s14zGroup.Where(c => c.集計年月 == i年月12).Select(c => c.運送収入).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月3).Select(c => c.運送収入).Sum(),
					//								運送収入13 = s14zGroup.Where(c => c.集計年月 >= i年月1 && c.集計年月 <= i年月12).Select(c => c.運送収入).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 >= i年月1 && c.集計年月 <= i年月12).Select(c => c.運送収入).Sum(),
					//								運送収入14 = s14zGroup.Where(c => c.集計年月 >= i年月1 && c.集計年月 <= i年月12).Select(c => c.運送収入).Sum() / 12,
					//								運送収入15 = 0,

					//								一般管理費1 = s14zGroup.Where(c => c.集計年月 == i年月1).Select(c => c.一般管理費).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月1).Select(c => c.一般管理費).Sum(),
					//								一般管理費2 = s14zGroup.Where(c => c.集計年月 == i年月2).Select(c => c.一般管理費).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月2).Select(c => c.一般管理費).Sum(),
					//								一般管理費3 = s14zGroup.Where(c => c.集計年月 == i年月3).Select(c => c.一般管理費).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月3).Select(c => c.一般管理費).Sum(),
					//								一般管理費4 = s14zGroup.Where(c => c.集計年月 == i年月4).Select(c => c.一般管理費).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月4).Select(c => c.一般管理費).Sum(),
					//								一般管理費5 = s14zGroup.Where(c => c.集計年月 == i年月5).Select(c => c.一般管理費).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月5).Select(c => c.一般管理費).Sum(),
					//								一般管理費6 = s14zGroup.Where(c => c.集計年月 == i年月6).Select(c => c.一般管理費).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月6).Select(c => c.一般管理費).Sum(),
					//								一般管理費7 = s14zGroup.Where(c => c.集計年月 == i年月7).Select(c => c.一般管理費).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月7).Select(c => c.一般管理費).Sum(),
					//								一般管理費8 = s14zGroup.Where(c => c.集計年月 == i年月8).Select(c => c.一般管理費).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月8).Select(c => c.一般管理費).Sum(),
					//								一般管理費9 = s14zGroup.Where(c => c.集計年月 == i年月9).Select(c => c.一般管理費).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月9).Select(c => c.一般管理費).Sum(),
					//								一般管理費10 = s14zGroup.Where(c => c.集計年月 == i年月10).Select(c => c.一般管理費).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月10).Select(c => c.一般管理費).Sum(),
					//								一般管理費11 = s14zGroup.Where(c => c.集計年月 == i年月11).Select(c => c.一般管理費).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月11).Select(c => c.一般管理費).Sum(),
					//								一般管理費12 = s14zGroup.Where(c => c.集計年月 == i年月12).Select(c => c.一般管理費).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 == i年月12).Select(c => c.一般管理費).Sum(),
					//								一般管理費13 = s14zGroup.Where(c => c.集計年月 >= i年月1 && c.集計年月 <= i年月12).Select(c => c.一般管理費).Sum() == null ? 0 : s14zGroup.Where(c => c.集計年月 >= i年月1 && c.集計年月 <= i年月12).Select(c => c.一般管理費).Sum(),
					//								一般管理費14 = s14zGroup.Where(c => c.集計年月 >= i年月1 && c.集計年月 <= i年月12).Select(c => c.一般管理費).Sum() / 12,
					//								一般管理費15 = 0,
					//							}).AsQueryable();
					//};
                    ...
                    //          join s14 in context.S14_CAR.Where(c => c.集計年月 >= i開始年月 && c.集計年月 <= i終了年月) on car.車輌KEY equals s14.車輌KEY
                    //          select new SRY08010g_Member
                    //          {
                    //              車輌KEY = car.車輌KEY,
                    //              車輌ID = car.車輌ID,
					...
					var carlistzz = carlistz.Where(c => c.廃車日 == null || ((((DateTime)c.廃車日).Year * 100 + ((DateTime)c.廃車日).Month) >= i開始年月)).ToList();
                    ...
                    var prelistz = (from car in carlistz
                                    ...
                                    select new SRY08010_PRELIST_Member
                                    {
                    ...
                    var prelist = (from pre in prelistz
                                   join s14 in context.S14_CARSB.Where(c => c.集計年月 >= i開始年月 && c.集計年月 <= i終了年月) on new { a = pre.車輌KEY, b = pre.経費ID } equals new { a = s14.車輌KEY, b = s14.経費項目ID } into s14Group
                                   ...
                                   select new SRY08010_PRELIST_Member
                                   {
                                       ...
                                       車輌ID = pre.車輌ID,
                                       車輌KEY = pre.車輌KEY,
                                       金額1 = s14Group.Where(c => c.集計年月 == i年月1).Select(c => c.金額).Sum(),
                                       金額2 = s14Group.Where(c => c.集計年月 == i年月2).Select(c => c.金額).Sum(),
                                       金額3 = s14Group.Where(c => c.集計年月 == i年月3).Select(c => c.金額).Sum(),
                                       金額4 = s14Group.Where(c => c.集計年月 == i年月4).Select(c => c.金額).Sum(),
                                       金額5 = s14Group.Where(c => c.集計年月 == i年月5).Select(c => c.金額).Sum(),
                                       金額6 = s14Group.Where(c => c.集計年月 == i年月6).Select(c => c.金額).Sum(),
                                       金額7 = s14Group.Where(c => c.集計年月 == i年月7).Select(c => c.金額).Sum(),
                                       金額8 = s14Group.Where(c => c.集計年月 == i年月8).Select(c => c.金額).Sum(),
                                       金額9 = s14Group.Where(c => c.集計年月 == i年月9).Select(c => c.金額).Sum(),
                                       金額10 = s14Group.Where(c => c.集計年月 == i年月10).Select(c => c.金額).Sum(),
                                       金額11 = s14Group.Where(c => c.集計年月 == i年月11).Select(c => c.金額).Sum(),
                                       金額12 = s14Group.Where(c => c.集計年月 == i年月12).Select(c => c.金額).Sum(),
                                       金額13 = s14Group.Where(c => c.集計年月 >= i年月1 && c.集計年月 <= i年月12).Select(c => c.金額).Sum(),
                    ...
                    foreach (SRY08010g_Member a in carlist)
                    {
                    ...
                    foreach (SRY08010g_Member a in carlist)
                    {
                        carid1 = a.車輌KEY;
                            ...
                            List<SRY08010_PRELIST_Member> plist = (from p in prelist
                                                                   where p.車輌KEY == carid1
                                                                  select p).ToList();

                            SRY08010g_Member a1 = (from p in carlist where p.車輌KEY == carid1 select p).FirstOrDefault();
                            ...
                            if ((from s14s in context.S14_CARSB
                                 where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月1 && s14s.車輌KEY == carid1
                                 select s14s.金額).Any())
                            {
                                syaryoutyokusetuhi1 = (from s14s in context.S14_CARSB
                                                       where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月1 && s14s.車輌KEY == carid1
                                                       select s14s.金額).Sum();
                            }

                            if ((from s14s in context.S14_CARSB
                                 where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月2 && s14s.車輌KEY == carid1
                                 select s14s.金額).Any())
                            {
                                syaryoutyokusetuhi2 = (from s14s in context.S14_CARSB
                                                       where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月2 && s14s.車輌KEY == carid1
                                                       select s14s.金額).Sum();
                            }

                            if ((from s14s in context.S14_CARSB
                                 where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月3 && s14s.車輌KEY == carid1
                                 select s14s.金額).Any())
                            {
                                syaryoutyokusetuhi3 = (from s14s in context.S14_CARSB
                                                       where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月3 && s14s.車輌KEY == carid1
                                                       select s14s.金額).Sum();
                            }

                            if ((from s14s in context.S14_CARSB
                                 where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月4 && s14s.車輌KEY == carid1
                                 select s14s.金額).Any())
                            {
                                syaryoutyokusetuhi4 = (from s14s in context.S14_CARSB
                                                       where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月4 && s14s.車輌KEY == carid1
                                                       select s14s.金額).Sum();
                            }

                            if ((from s14s in context.S14_CARSB
                                 where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月5 && s14s.車輌KEY == carid1
                                 select s14s.金額).Any())
                            {
                                syaryoutyokusetuhi5 = (from s14s in context.S14_CARSB
                                                       where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月5 && s14s.車輌KEY == carid1
                                                       select s14s.金額).Sum();
                            }

                            if ((from s14s in context.S14_CARSB
                                 where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月6 && s14s.車輌KEY == carid1
                                 select s14s.金額).Any())
                            {
                                syaryoutyokusetuhi6 = (from s14s in context.S14_CARSB
                                                       where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月6 && s14s.車輌KEY == carid1
                                                       select s14s.金額).Sum();
                            }

                            if ((from s14s in context.S14_CARSB
                                 where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月7 && s14s.車輌KEY == carid1
                                 select s14s.金額).Any())
                            {
                                syaryoutyokusetuhi7 = (from s14s in context.S14_CARSB
                                                       where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月7 && s14s.車輌KEY == carid1
                                                       select s14s.金額).Sum();
                            }

                            if ((from s14s in context.S14_CARSB
                                 where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月8 && s14s.車輌KEY == carid1
                                 select s14s.金額).Any())
                            {
                                syaryoutyokusetuhi8 = (from s14s in context.S14_CARSB
                                                       where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月8 && s14s.車輌KEY == carid1
                                                       select s14s.金額).Sum();
                            }

                            if ((from s14s in context.S14_CARSB
                                 where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月9 && s14s.車輌KEY == carid1
                                 select s14s.金額).Any())
                            {
                                syaryoutyokusetuhi9 = (from s14s in context.S14_CARSB
                                                       where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月9 && s14s.車輌KEY == carid1
                                                       select s14s.金額).Sum();
                            }

                            if ((from s14s in context.S14_CARSB
                                 where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月10 && s14s.車輌KEY == carid1
                                 select s14s.金額).Any())
                            {
                                syaryoutyokusetuhi10 = (from s14s in context.S14_CARSB
                                                       where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月10 && s14s.車輌KEY == carid1
                                                       select s14s.金額).Sum();
                            }

                            if ((from s14s in context.S14_CARSB
                                 where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月11 && s14s.車輌KEY == carid1
                                 select s14s.金額).Any())
                            {
                                syaryoutyokusetuhi11 = (from s14s in context.S14_CARSB
                                                       where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月11 && s14s.車輌KEY == carid1
                                                       select s14s.金額).Sum();
                            }

                            if ((from s14s in context.S14_CARSB
                                 where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月12 && s14s.車輌KEY == carid1
                                 select s14s.金額).Any())
                            {
                                syaryoutyokusetuhi12 = (from s14s in context.S14_CARSB
                                                       where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 == i年月12 && s14s.車輌KEY == carid1
                                                       select s14s.金額).Sum();
                            }

                            if ((from s14s in context.S14_CARSB
                                 where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 >= i年月1 && s14s.集計年月 <= i年月12 && s14s.車輌KEY == carid1
                                 select s14s.金額).Any())
                            {
                                syaryoutyokusetuhi13 = (from s14s in context.S14_CARSB
                                                       where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 >= i年月1 && s14s.集計年月 <= i年月12 && s14s.車輌KEY == carid1
                                                       select s14s.金額).Sum();
                            }
                            ...
                            if ((from s14s in context.S14_CARSB
                                 ...
                                 select s14s.金額).Any())
                            {
                                syaryoutyokusetuhi14 = (from s14s in context.S14_CARSB
                                                        where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 >= i年月1 && s14s.集計年月 <= i年月12 && s14s.車輌KEY == carid1
                                                        select s14s.金額).Sum() / 12;
                            }
                            if ((from s14s in context.S14_CARSB
                                 where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 >= i年月1 && s14s.集計年月 <= i年月12 && s14s.車輌KEY == carid1
                                 select s14s.金額).Any())
                            {
                                ...
                                {
                                    syaryoutyokusetuhi15 = (from s14s in context.S14_CARSB
                                                            where prt_GROPID.Contains(s14s.経費項目ID) && s14s.集計年月 >= i年月1 && s14s.集計年月 <= i年月12 && s14s.車輌KEY == carid1
                                                            select s14s.金額).Sum() / (decimal)a1.運送収入13 * 100;
                                }
                            }
                            ...
                            foreach (var row in plist)
                            {
                                ...
                                SRY08010_Member list = new SRY08010_Member()
                                {
                                    一般管理費1 = a1.一般管理費1,
                                    一般管理費2 = a1.一般管理費2,
                                    一般管理費3 = a1.一般管理費3,
                                    ...
                                    運送収入13 = a1.運送収入13,
                                    運送収入14 = a1.運送収入14,
                                    運送収入15 = a1.運送収入13 == 0 ? 0 : a1.運送収入13 / a1.運送収入13 * 100,
                                    ...
                                    //            where s14s.集計年月 == i年月1 && s14s.経費項目ID == row.経費ID && s14s.車輌KEY == carid1
                                    ...
                                    //           (from s14s in context.S14_CARSB
                                    //            where s14s.集計年月 == i年月2 && s14s.経費項目ID == row.経費ID && s14s.車輌KEY == carid1
                                    //            select s14s.金額).FirstOrDefault(),
                                    ...
                                    //           (from s14s in context.S14_CARSB
                                    //            where s14s.集計年月 == i年月3 && s14s.経費項目ID == row.経費ID && s14s.車輌KEY == carid1
                                    //            select s14s.金額).FirstOrDefault(),
                                    ...
                                    //           (from s14s in context.S14_CARSB
                                    //            where s14s.集計年月 == i年月4 && s14s.経費項目ID == row.経費ID && s14s.車輌KEY == carid1
                                    //            select s14s.金額).FirstOrDefault(),
                                    ...
                                    //            (from s14s in context.S14_CARSB
                                    //             where s14s.集計年月 == i年月5 && s14s.経費項目ID == row.経費ID && s14s.車輌KEY == carid1
                                    //             select s14s.金額).FirstOrDefault(),
                                    ...
                                    //           (from s14s in context.S14_CARSB
                                    //            where s14s.集計年月 == i年月6 && s14s.経費項目ID == row.経費ID && s14s.車輌KEY == carid1
                                    //            select s14s.金額).FirstOrDefault(),
                                    ...
                                    //           (from s14s in context.S14_CARSB
                                    //            where s14s.集計年月 == i年月7 && s14s.経費項目ID == row.経費ID && s14s.車輌KEY == carid1
                                    //            select s14s.金額).FirstOrDefault(),
                                    ...
                                    //           (from s14s in context.S14_CARSB
                                    //            where s14s.集計年月 == i年月8 && s14s.経費項目ID == row.経費ID && s14s.車輌KEY == carid1
                                    //            select s14s.金額).FirstOrDefault(),
                                    ...
                                    //            (from s14s in context.S14_CARSB
                                    //             where s14s.集計年月 == i年月9 && s14s.経費項目ID == row.経費ID && s14s.車輌KEY == carid1
                                    //             select s14s.金額).FirstOrDefault(),
                                    ...
                                    //           (from s14s in context.S14_CARSB
                                    //            where s14s.集計年月 == i年月10 && s14s.経費項目ID == row.経費ID && s14s.車輌KEY == carid1
                                    //            select s14s.金額).FirstOrDefault(),
                                    ...
                                    //           (from s14s in context.S14_CARSB
                                    //            where s14s.集計年月 == i年月11 && s14s.経費項目ID == row.経費ID && s14s.車輌KEY == carid1
                                    //            select s14s.金額).FirstOrDefault(),
                                    ...
                                    //           (from s14s in context.S14_CARSB
                                    //            where s14s.集計年月 == i年月12 && s14s.経費項目ID == row.経費ID && s14s.車輌KEY == carid1
                                    //            select s14s.金額).FirstOrDefault(),
                                    ...
                                    //           (from s14s in context.S14_CARSB
                                    //            where s14s.集計年月 >= i年月1 && s14s.集計年月 <= i年月12 && s14s.経費項目ID == row.経費ID && s14s.車輌KEY == carid1
                                    //            select s14s.金額).Sum(),
		...
		#region SRY08010 印刷
		public List<SRY08010_PRELIST_Member_CSV> SRY08010_GetData_CSV(string s車輌From, string s車輌To, int?[] i車輌List, string s車輌List, int 年, int 月)
		{
			using (TRAC3Entities context = new TRAC3Entities(CommonData.TRAC3_GetConnectionString()))
			{
				DateTime dDate = new DateTime(年, 月, 1);
				...
				List<SRY08010_PRELIST_Member_CSV> retList = new List<SRY08010_PRELIST_Member_CSV>();
				...
				try
				{
					...
					foreach (SRY08010g_Member a in carlist)
					{
						...
						SRY08010_PRELIST_Member_CSV list = new SRY08010_PRELIST_Member_CSV()
						{
							車輌ID = a1.車輌ID,
							車輌番号 = a1.車輌番号,
							項目名 = "運送収入",
						...
						foreach (var row in plist)
						{
							...
							list = new SRY08010_PRELIST_Member_CSV()
							{
								車輌ID = a1.車輌ID,
								車輌番号 = a1.車輌番号,
								項目名 = row.経費項目名,
