...
namespace KyoeiSystem.Application.WCFService
{
    ...
    public class BSK04010
    {
        ...
        /// 帳票印刷メンバクラス
        /// </summary>
        public class BSK04010_PrintMember
        {
        ...
        /// <returns></returns>
        public List<BSK04010_PrintMember> GetPrintList(Dictionary<string, string> paramDic)
        {
            // パラメータ展開
            int ival,
            ...
            using (TRAC3Entities context = new TRAC3Entities(CommonData.TRAC3_GetConnectionString()))
            {
                ...
                // 得意先毎に集計を実施
                List<BSK04010_PrintMember> resultList = new List<BSK04010_PrintMember>();
                foreach (M01_TOK tokRow in tok)
                {
                    ...
                    List<BSK04010_PrintMember> printList = new List<BSK04010_PrintMember>();
                    int monthCount = 1;
                    foreach (int dicKey in tokDic.Keys)
                    {
                        ...
                        {
                            BSK04010_PrintMember print = new BSK04010_PrintMember();
                    ...
                    printList =
                        printList.AsEnumerable()
                            ...
                            .Select(s => new BSK04010_PrintMember
                            {
