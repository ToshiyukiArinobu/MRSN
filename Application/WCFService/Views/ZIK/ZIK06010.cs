                                ...
                                .Select(s => new SearchDataMember
                                    {
                                        ...
                                        倉庫コード = s.STOK_MONTH.倉庫コード,
                                        倉庫名 = s.SOUK != null ? s.SOUK.倉庫略称名 : "",
                    ...
                    try
                    {
                        ...
                        var inputData = dt.AsEnumerable().Where(w => w.Field<int>("締年月") == yearMonth)
                                            ...
                                            .Select(s => new InputDataMember
                                            {
                                                ...
                                                仕入単価 = s.ORG.Field<string>("調整単価") == null ?
                                                                Decimal.TryParse(s.ORG.Field<string>("仕入単価"), out dval) ? dval : 0 :
                                                          Decimal.TryParse(s.ORG.Field<string>("調整単価"), out dval) ? dval : 0
                                            });
