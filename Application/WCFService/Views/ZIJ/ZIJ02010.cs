                        ...
                        srDataList
                            ...
                            .Select(x => new SearchDataMember
                            {
                                ...
                                支払日 = x.SHD.仕入日.Day >= x.TOK.Ｓ締日 ?
                                    new DateTime(x.SHD.仕入日.Year, x.SHD.仕入日.Month, x.TOK.Ｓ入金日１ ?? DateTime.DaysInMonth(x.SHD.仕入日.Year, x.SHD.仕入日.Month)).AddMonths((x.TOK.Ｔサイト１ ?? 0) + 1) :
                                    new DateTime(x.SHD.仕入日.Year, x.SHD.仕入日.Month, x.TOK.Ｓ入金日１ ?? DateTime.DaysInMonth(x.SHD.仕入日.Year, x.SHD.仕入日.Month)).AddMonths(x.TOK.Ｔサイト１ ?? 0),
