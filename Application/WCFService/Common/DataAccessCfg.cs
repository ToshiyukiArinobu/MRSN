...
namespace KyoeiSystem.Application.WCFService
{
    ...
    public static class DataAccessCfg
    {
        ...
        private static List<WCFDataAccessConfig> daccfglist = new List<WCFDataAccessConfig>()
		{
            ...
            // セット品番マスタ一括更新
            new WCFDataAccessConfig() { Name = "MST10011_GetData", ServiceClass = "MST10011", MethodName = "GetData", Descprition = "セット品番マスタ一括更新 データ 取得" },
            new WCFDataAccessConfig() { Name = "MST10011_Update", ServiceClass = "MST10011", MethodName = "Update", Descprition = "セット品番マスタ一括更新 データ　更新" },
            ...
            new WCFDataAccessConfig() { Name = "T11_GetYoteiData", ServiceClass = "T11", MethodName = "GetYoteiData", Descprition = "得意先情報の取得" },
            ...
            // 売掛台帳
            new WCFDataAccessConfig() { Name = "TKS02012_GetCsvData", ServiceClass = "TKS02012", MethodName = "GetCsvData", Descprition = "売上集計、一覧表ＣＳＶデータ取得" },
            new WCFDataAccessConfig() { Name = "TKS02012_GetPrintData", ServiceClass = "TKS02012", MethodName = "GetPrintData", Descprition = "売上集計処理、一覧表印刷データ取得" },
            // 納品書出力
            ...
            new WCFDataAccessConfig() { Name = "TKS01020_GetReceiptData", ServiceClass = "TKS01020", MethodName = "GetPrintData", Descprition = "領収書印刷データ取得" },
            new WCFDataAccessConfig() { Name = "TKS01020_DataDelete", ServiceClass = "TKS01020", MethodName = "DataDelete", Descprition = "請求書データ削除" },
            ...
            new WCFDataAccessConfig() { Name = "BSK06010_KouseihinProduct", ServiceClass = "BSK06010", MethodName = "GetProductData", Descprition = "品番情報を取得" },
            new WCFDataAccessConfig() { Name = "BSK06010_ShizaiProduct", ServiceClass = "BSK06010", MethodName = "GetProductData", Descprition = "品番情報を取得" },
            new WCFDataAccessConfig() { Name = "BSK06010_GetSetHinProduct", ServiceClass = "BSK06010", MethodName = "GetProductData", Descprition = "セット品の品番情報を取得" },
            new WCFDataAccessConfig() { Name = "BSK06010_GetBaikaData", ServiceClass = "BSK06010", MethodName = "GetBaikaData", Descprition = "仕入先売価マスタを取得" },
            new WCFDataAccessConfig() { Name = "BSK06010_UpdateData", ServiceClass = "BSK06010", MethodName = "Update", Descprition = "製品原価表登録" },
            new WCFDataAccessConfig() { Name = "BSK06010_UpdatePrint", ServiceClass = "BSK06010", MethodName = "Update", Descprition = "製品原価表登録" },
            new WCFDataAccessConfig() { Name = "BSK06010_GetNewSHinProduct", ServiceClass = "BSK06010", MethodName = "GetNewShin", Descprition = "製品原価表登録" },
            new WCFDataAccessConfig() { Name = "BSK06010_DeleteData", ServiceClass = "BSK06010", MethodName = "Delete", Descprition = "製品原価表削除" },
            new WCFDataAccessConfig() { Name = "M10_NEWSHIN_SCH", ServiceClass = "BSK06010", MethodName = "GetSearchData", Descprition = "検索画面用データ 取得" },
