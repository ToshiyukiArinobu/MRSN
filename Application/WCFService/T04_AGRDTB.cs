...
namespace KyoeiSystem.Application.WCFService
{
    ...
    public partial class T04_AGRDTB: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int 部材行番号
        {
            ...
            set
            {
                if (_部材行番号 != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property '部材行番号' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _部材行番号 = value;
                    OnPropertyChanged("部材行番号");
                }
            }
        }
        private int _部材行番号;
