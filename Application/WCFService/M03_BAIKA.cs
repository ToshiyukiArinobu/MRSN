...
namespace KyoeiSystem.Application.WCFService
{
    ...
    public partial class M03_BAIKA: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int 仕入先コード
        {
            ...
            set
            {
                if (_仕入先コード != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property '仕入先コード' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _仕入先コード = value;
