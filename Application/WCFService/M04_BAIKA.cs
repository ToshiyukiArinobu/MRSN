...
namespace KyoeiSystem.Application.WCFService
{
    ...
    public partial class M04_BAIKA: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public int 外注先コード
        {
            ...
            set
            {
                if (_外注先コード != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property '外注先コード' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _外注先コード = value;
                    OnPropertyChanged("外注先コード");
                }
            }
        }
        private int _外注先コード;
