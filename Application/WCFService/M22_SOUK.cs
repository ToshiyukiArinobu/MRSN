...
namespace KyoeiSystem.Application.WCFService
{
    ...
    public partial class M22_SOUK: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public string 倉庫略称名
        {
            ...
            set
            {
                ...
                {
                    _倉庫略称名 = value;
                    OnPropertyChanged("倉庫略称名");
                }
            }
        }
        private string _倉庫略称名;
        ...
        public int 場所会社コード
        {
            ...
            set
            {
                ...
                {
                    _場所会社コード = value;
                    OnPropertyChanged("場所会社コード");
                }
            }
        }
        private int _場所会社コード;
        ...
        public int 寄託会社コード
        {
            ...
            set
            {
                ...
                {
                    _寄託会社コード = value;
                    OnPropertyChanged("寄託会社コード");
                }
            }
        }
        private int _寄託会社コード;
