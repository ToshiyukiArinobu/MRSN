...
namespace KyoeiSystem.Application.Windows.Views
{
    ...
    /// 外注先商品売価設定
    /// </summary>
    public partial class MST18010 : WindowMasterMainteBase
    {
        /// <summary>
        /// 遷移元画面
        /// </summary>
        ...
        /// <summary>自社品番と色から品番情報を取得</summary>
        private const string SearchProductData = "UcGetProductHinIro";        // No-379 Add
        ...
        private const string SearchTableToProduct = "M04_BAIKA_GetData_Product";
        /// <summary>外注先売価情報登録</summary>
        private const string M02_BAIKA_Update = "M04_BAIKA_Update";
        /// <summary>品番情報取得</summary>
        private const string MasterCode_Product = "UcProduct";

        /// <summary>この画面が対応する取引区分</summary>
        private const int TARGET_TRADING_KBN = 2;   // 外注先
        ...
        //※ 必ず public で定義する。
        //</summary>
        public class ConfigMST18010 : FormConfigBase
        {
        ...
        /// ※ 必ず public で定義する。
        public ConfigMST18010 frmcfg = null;
        ...
        public string OutsourceEda { get; set; }
        ...
        private void sendSearchForOutsource()
        {
            base.SendRequest(
                new CommunicationObject(
                    ...
                    new object[] {
                            this.GAITHUSAKI.Text1,
                            this.GAITHUSAKI.Text2
                        }));
        }
        ...
        private void ScreenClear()
        {
            ...
            // 各項目のクリア
            this.GAITHUSAKI.Text1 = string.Empty;
            this.GAITHUSAKI.Text2 = string.Empty;
            this.GAITHUSAKI.Label2Text = string.Empty;
            ...
            this.GAITHU_NAME.Text = string.Empty;
        ...
        private void setFiltterEvent(bool isAdd)
        {
            if (isAdd)
            {
                ...
                this.GAITHU_NAME.cTextChanged += textFillter_cTextChanged;
        ...
        private void SetTblData(DataTable tbl)
        {
            ...
            {
                sb.Append(" AND");
                sb.AppendFormat(" ( 外注先名１ LIKE '%{0}%'", this.GAITHU_NAME.Text);
                sb.AppendFormat(" OR 外注先名２ LIKE '%{0}%' )", this.GAITHU_NAME.Text);
            }
        ...
        private void setSearchControlEnabled()
        {
            ...
            this.GAITHUSAKI.IsEnabled = (SendFormId != (int)SEND_FORM.品番マスタ);
        ...
        private void setFilterControlEnabled(bool isEnabled)
        {
            if (isEnabled)
            {
                ...
                this.GAITHUSAKI.IsEnabled = false;
            ...
            this.GAITHU_NAME.IsEnabled = (isEnabled && SendFormId != (int)SEND_FORM.取引先マスタ);
        ...
        {
            // 検索条件に入力がない場合(外注先コード＋枝番 or 品番＋色)
            ...
            if ((!string.IsNullOrEmpty(this.GAITHUSAKI.Text1) || !string.IsNullOrEmpty(this.GAITHUSAKI.Text2)) &&
                (!string.IsNullOrEmpty(this.HINBAN.Text1) || !string.IsNullOrEmpty(this.COLOR.Text1)))
            {
                MessageBox.Show("外注先と品番のどちらかを選択して入力して下さい", "入力エラー", MessageBoxButton.OK, MessageBoxImage.Error);
                return false;
            }
