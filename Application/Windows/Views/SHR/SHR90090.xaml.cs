...
namespace KyoeiSystem.Application.Windows.Views
{
    ...
    /// 支払締データ削除画面
    /// </summary>
    public partial class SHR90090 : WindowReportBase
    {
        #region 画面設定項目
        /// <summary>
        /// ユーザ設定項目
        ...
        /// ※ 必ず public で定義する。
        /// </summary>
        public class ConfigSHR90090 : FormConfigBase
        {
            public byte[] spConfig = null;
        }

        /// ※ 必ず public で定義する。
        public ConfigSHR90090 frmcfg = null;
        ...
        private const string TKS01020_SEARCHLIST = "SHR90090_GetDataList";
        private const string TKS01020_DELETE = "SHR90090_DataDelete";
        ...
        public string SelectedPrinterName
        {
            ...
            set
            {
                ...
                if (this.frmcfg == null)
                {
                    this.frmcfg = new ConfigSHR90090();
                }
        ...
        public override void OnF12Key(object sender, KeyEventArgs e)
        {
            ...
            if (cnt == 0)
            {
                base.ErrorMessage = "削除対象が選択されていません。";
                return;
            }
