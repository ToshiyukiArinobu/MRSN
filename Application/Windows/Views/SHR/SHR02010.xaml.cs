...
namespace KyoeiSystem.Application.Windows.Views
{
    ...
    public partial class SHR02010 : WindowReportBase
    {
        ...
        private const string ACCOUNTS_PAYABLE_PRT = "SHR02010_GetPrintData";

        /// <summary>買掛データ集計、CSVファイル出力データ取得</summary>
        private const string ACCOUNTS_PAYABLE_PRT_CSV = "SHR02010_GetCsvData";

        /// <summary>帳票定義ファイル 格納パス</summary>
        private const string ReportTemplateFileName = @"Files\SHR\SHR02010.rpt";
