...
namespace KyoeiSystem.Application.Windows.Views
{
    ...
    /// 支払一覧表画面クラス
    /// </summary>
    public partial class SHR05010 : WindowReportBase
    {
        #region << 列挙型定義 >>
        ...
        private const string SEARCH_SHR05010_CSV = "SHR05010_GetCsvData";

        /// <summary>帳票印刷データ取得</summary>
        private const string SEARCH_SHR05010_PRT = "SHR05010_GetPrintData";
        ...
        /// ※ 必ず public で定義する。
        /// </summary>
        public class ConfigSHR05010 : FormConfigBase
        {

        }
        /// ※ 必ず public で定義する。
        public ConfigSHR05010 frmcfg = null;
        ...
        private void RibbonWindow_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            frmcfg = (ConfigSHR05010)ucfg.GetConfigValue(typeof(ConfigSHR05010));
            ccfg = (CommonConfig)ucfg.GetConfigValue(typeof(CommonConfig));

            if (frmcfg == null)
            {
                frmcfg = new ConfigSHR05010();
