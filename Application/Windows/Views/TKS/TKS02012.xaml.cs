...
namespace KyoeiSystem.Application.Windows.Views
{
    ...
    /// インボイス対応売掛台帳画面クラス
    /// </summary>
    public partial class TKS02012 : WindowReportBase
    {
        #region << 列挙型定義 >>
        ...
        private const string ACCOUNTS_RECEIVABLE_PRT = "TKS02012_GetPrintData";

        /// <summary>売掛データ集計、CSVファイル出力データ取得</summary>
        private const string ACCOUNTS_RECEIVABLE_PRT_CSV = "TKS02012_GetCsvData";

        /// <summary>帳票定義ファイル 格納パス</summary>
        private const string ReportTemplateFileName = @"Files\TKS\TKS02012.rpt";
        ...
        /// ※ 必ず public で定義する。
        /// </summary>
        public class ConfigTKS02011 : FormConfigBase
        {

        }
        /// ※ 必ず public で定義する。
        public ConfigTKS02011 frmcfg = null;
        ...
        private void RibbonWindow_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            frmcfg = (ConfigTKS02011)ucfg.GetConfigValue(typeof(ConfigTKS02011));
            ccfg = (CommonConfig)ucfg.GetConfigValue(typeof(CommonConfig));

            if (frmcfg == null)
            {
                frmcfg = new ConfigTKS02011();
        ...
        private bool CheckInputErr()
        {
            ...
            {
                Customer.Focus();
                ErrorMessage = "得意先締期間で出力する場合は得意先をしていしてください。";
                return false;
            }
