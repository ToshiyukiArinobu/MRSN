...
namespace KyoeiSystem.Application.Windows.Views
{
    ...
    /// 請求一覧表画面クラス
    /// </summary>
    public partial class TKS03010 : WindowReportBase
    {
        #region << 列挙型定義 >>
        ...
        private const string SEARCH_TKS03010_CSV = "TKS03010_GetCsvData";

        /// <summary>帳票印刷データ取得</summary>
        private const string SEARCH_TKS03010_PRT = "TKS03010_GetPrintData";

        /// <summary>帳票定義ファイル 格納パス</summary>
        private const string ReportTemplateFileName = @"Files\TKS\TKS03010.rpt";
        ...
        /// ※ 必ず public で定義する。
        /// </summary>
        public class ConfigTKS03010 : FormConfigBase
        {

        }
        /// ※ 必ず public で定義する。
        public ConfigTKS03010 frmcfg = null;
        ...
        private void RibbonWindow_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            frmcfg = (ConfigTKS03010)ucfg.GetConfigValue(typeof(ConfigTKS03010));
            ccfg = (CommonConfig)ucfg.GetConfigValue(typeof(CommonConfig));

            if (frmcfg == null)
            {
                frmcfg = new ConfigTKS03010();
        ...
        private void DispPreviw(DataTable tbl)
        {
            try
            {
                ...
                // 第2引数　帳票ファイルPass
                // 第3以上　帳票の開始点(0で良い)
                view.MakeReport("請求一覧表", ReportTemplateFileName, 0, 0, 0);
                // 帳票ファイルに送るデータ。
